...
-- Database: `padrao`
--
  CREATE DATABASE IF NOT EXISTS `padrao(1)`;
  USE `padrao(1)`;
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbl_nfse` (
  ...
  `razaosocialtomador` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_os` (
  ...
  `kmentrada` varchar(9) DEFAULT NULL,
